...
router.get('/summary', function (req, res) {
  ...
  res.render('summary', {
    ...
    main: {
      summary: {
        title: 'Summary',
        text: `Open-minded for new technologies, with 1 years of experience in development. Whenever I start to work on a new project 
					I learn the domain and try to understand the idea of the project. Good team player, every colleague is a friend to me.`,
      },
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        { name: 'ЗакДУ', isEnd: true },
        { name: 'УжНУ', isEnd: false },
      ],
      certificates: [
        { name: 'A', id: 5364 },
        { name: 'B', id: 5365 },
          ...
          projects: [
            {
              name: 'Resume',
              url: 'https:/it-brains.com.ua/',
              about: 'About my studying and work',
              stackAmount: 3,
              awardAmount: 2,
              stacks: [
                {
              ...
              awards: [
                {
                  name: 'True fullstack developer',
                },
                {
                  name: 'Big experience of working with JS',
                },
              ],
            },
          ],
